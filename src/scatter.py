...
class ScatterToolUI(QtWidgets.QDialog):
    ...
    def _create_filename_ui(self):
        ...
        self.descriptor_le.setFixedWidth(50)
        self.task_le = QtWidgets.QLineEdit(self.scenefile.task)
        self.task_le.setFixedWidth(50)
        self.ver_le = QtWidgets.QLineEdit(self.scenefile.descriptor)
        self.ver_le.setFixedWidth(50)
        self.ver_le = QtWidgets.QLineEdit(self.scenefile.descriptor)
        self.ext_lbl = QtWidgets.QLabel("Random Scale Minimum")
        layout.addWidget(self.descriptor_le, 1, 0)
        layout.addWidget(self.task_le, 1, 2)
        layout.addWidget(self.ver_le, 1, 4)
